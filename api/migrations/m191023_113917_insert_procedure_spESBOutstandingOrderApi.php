...
/**
 * Class m191023_113917_insert_procedure_spESBOutstandingOrderApi
 */
class m191023_113917_insert_procedure_spESBOutstandingOrderApi extends Migration {
    /**
     * {@inheritdoc}
     */
    public function up() {
        $this->execute('DROP PROCEDURE IF EXISTS `spESBOutstandingOrderApi`');
